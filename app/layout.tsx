...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "order meat online Lagos",
      "order chicken in Lagos",
      "buy chicken in Lagos",
      "beef delivery Lagos",
      "goat meat Lagos",
      "turkey Lagos",
      "assorted meat Lagos",
      ...
      "fresh meat Lagos",
      "frozen meat Lagos",
      "online butcher Lagos",
      "party meat Lagos",
      "owambe meat",
      "same-day meat delivery Lagos",
      "meat delivery Yaba",
      "meat delivery Igbobi",
      "meat delivery Lekki",
      "meat delivery Victoria Island",
      "meat delivery Lagos mainland",
      brand,
    ],
